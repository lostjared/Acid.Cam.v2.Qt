...
INCLUDEPATH += . C:\code\Acid.Cam.v2.Qt-master\Acid.Cam.v2.Qt-master\src\opencv\include
#INCLUDEPATH += . C:\OpenCV\opencv\build\include /usr/include/ /usr/local/include
#put path to OpenCV Librarys here
LIBS += ./libs/libopencv*a -lopengl32 -lglu32
